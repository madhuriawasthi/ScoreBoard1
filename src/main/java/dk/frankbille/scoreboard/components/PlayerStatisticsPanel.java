	...
	public PlayerStatisticsPanel(String id, final IModel<Player> selectedPlayerModel, final League league, final RatingCalculator rating) {
		...
		add(new ListView<PlayerResult>("players", playerResultsModel) {
			...
			protected void populateItem(final ListItem<PlayerResult> item) {
				...
				WebComponent lose = new WebComponent("lose") {
					private static final long serialVersionUID = 1L;
				...
				win.add(AttributeModifier.append("class", new AbstractReadOnlyModel<String>() {
					private static final long serialVersionUID = 1L;
				...
				lose.add(AttributeModifier.append("class", new AbstractReadOnlyModel<String>() {
					private static final long serialVersionUID = 1L;
				...
				item.add(new Label("win",playerResult.getGamesWon()));
				item.add(new Label("lose",playerResult.getGamesLost()));
